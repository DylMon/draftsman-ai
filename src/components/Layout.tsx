...
export default function Layout() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100">
      <nav className="px-6 py-4 bg-white/95 backdrop-blur-md border-b border-slate-300 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            ...
            <button className="px-6 py-2.5 bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors">
              Join Waitlist
            </button>
          </div>
        </div>
